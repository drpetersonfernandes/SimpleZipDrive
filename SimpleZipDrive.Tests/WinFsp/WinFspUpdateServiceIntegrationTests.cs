...
public class WinFspUpdateServiceIntegrationTests
{
    ...
    public WinFspUpdateServiceIntegrationTests()
    {
    ...
    public async Task CheckForUpdateAsync_WhenNewerVersionAvailable_NotifiesUser()
    {
        ...
        var updateService = new SimpleZipDrive_WinFsp.Services.UpdateService(_fakeNotificationService, httpClient);
    ...
    public void Constructor_WithNullNotificationService_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            new SimpleZipDrive_WinFsp.Services.UpdateService(null!));
    }
    ...
    public void Constructor_WithNullHttpClient_ThrowsArgumentNullException()
    {
        // Arrange & Act & Assert
        Assert.Throws<ArgumentNullException>(() =>
            new SimpleZipDrive_WinFsp.Services.UpdateService(_fakeNotificationService, null!));
    }
